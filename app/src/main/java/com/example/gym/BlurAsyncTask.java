...
public class BlurAsyncTask extends AsyncTask<Void, Integer, Bitmap> {
    ...
    Context context;
   public BlurAsyncTask(AppCompatActivity activity, Context cont){
        appCompatActivity=activity;
        context=cont;
        fakeDialogUseToGetWindowForBlurEffect = new Dialog(context);
    }
    protected Bitmap doInBackground(Void... arg0) {

        Bitmap map = AppUtils.takeScreenShot((Activity)appCompatActivity);
    ...
    protected void onPostExecute(Bitmap result) {
        if (result != null){
            //okno tylko do blura
            final Drawable draw=new BitmapDrawable(context.getResources(),result);
